...
//                 className="w-12 h-12 text-xl text-center font-semibold border rounded-lg outline-none
//                            bg-gray-50 border-gray-300 focus:border-primary focus:bg-white transition"
//               />
//             ))}
//           </div>
...
//           <button
//             type="submit"
//             className="w-full h-12 bg-primary text-white cursor-pointer font-semibold rounded-lg 
